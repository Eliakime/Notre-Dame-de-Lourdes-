...
export default function Home() {
  ...
  const questions = [
    ['Quelle est la différence entre le lycée et le centre ?', 'Le lycée technique accueille les élèves de Seconde, Première et Terminale dans cinq filières. Le centre, situé au sein de l’établissement, propose sept formations professionnelles orientées vers un métier.'],
  ...
  return <>
    ...
    <main>
      <section className="hero wrap">
        ...
        <div className="hero-art hero-photo"><Image src="/images/hero-section.jpeg" width={1280} height={853} alt="Le lycée et le centre de formation : apprentissage en classe et pratique en atelier." preload sizes="(max-width: 760px) 100vw, 55vw"/><div className="hero-photo-caption"><span className="dot"/> Deux parcours, un même avenir.</div></div>
      </section>
      <Reveal><div className="numbers wrap"><div><strong>02<span> parcours</span></strong><p>Une ambition : votre avenir</p></div><div><strong>05<span> filières techniques</span></strong><p>De la Seconde à la Terminale</p></div><div><strong>07<span> formations métiers</span></strong><p>Au centre de formation</p></div><a href="#formations">Et vous,<br/><strong>quelle sera votre voie ? <ArrowDown/></strong></a></div></Reveal>
      <FormationExplorer/>
      <Reveal><section id="ecole" className="school section wrap"><div className="school-art school-photo"><Image src="/images/apprendre-aujourdhui.jpeg" width={853} height={1280} alt="Portrait d’une religieuse en habit bleu et blanc." sizes="(max-width: 760px) 100vw, 45vw"/></div><div className="school-copy"><div className="eyebrow">02 — UN LIEU POUR DEVENIR</div><h2>Apprendre aujourd’hui.<br/><em>Agir demain.</em></h2><p>Notre Dame de Lourdes réunit un lycée technique et un centre de formation sur un même site, à Dassa-Zoumè.</p><p>Notre vocation : accompagner les élèves et les apprenants dans l’acquisition de savoirs et de compétences utiles à leur avenir professionnel.</p><div className="value"><Check size={16}/><span><strong>Deux parcours complémentaires</strong>Une voie scolaire et une voie de formation professionnelle.</span></div><div className="value"><Check size={16}/><span><strong>Des métiers qui font avancer</strong>Du bâtiment au numérique, de l’énergie à la restauration.</span></div><a className="text-link" href={whatsapp} target="_blank" rel="noreferrer">Faire connaissance avec l’établissement <ArrowUpRight size={18}/></a></div></section></Reveal>
      <Reveal><section className="library-banner library-banner-illustrated wrap"><Image className="library-banner-image" src="/images/library/library.webp" alt="" fill sizes="100vw"/><div className="library-icon"><BookOpen size={48} strokeWidth={1}/></div><div><div className="eyebrow">L’ESPACE DES APPRENANTS</div><h2>Le savoir se partage.</h2><p>Retrouvez les documents de votre formation dans la bibliothèque.</p></div><Link href="/bibliotheque" className="button white">Explorer la bibliothèque <ArrowUpRight size={18}/></Link></section></Reveal>
