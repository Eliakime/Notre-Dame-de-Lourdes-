...
export function FormationExplorer() {
  ...
  return <section id="formations" className="formations section"><div className="wrap">
    ...
    <div className="tabs" role="tablist" aria-label="Type de formation">
      ...
      <button id="tab-centre" role="tab" aria-selected={tab === 'centre'} aria-controls="formation-panel" tabIndex={tab === 'centre' ? 0 : -1} onKeyDown={navigateTabs} onClick={() => setTab('centre')}><Wrench size={19}/> Le centre de formation <span>06</span></button>
    </div>
